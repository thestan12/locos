...
public class Maitre
{
	...
	public void teleportAllEsclaves()
	{
		...
		{
		p.sendMessage("Vous n'avez pas pus être téléporter car vous êtes occuper.");
		_maitre.sendMessage("Le héro "+p.getName()+" est occuper et n'as donc pas était téléporter.");
	    continue;
		}
