...
public class StaticsDatabase {
    ...
    public boolean initializeConnection() {
        try {
            ...
            config.addDataSourceProperty("serverName", "172.28.1.10");
            config.addDataSourceProperty("port", Main.loginPortDB);
            config.addDataSourceProperty("databaseName", "login");
            ...
            logger.info(Main.loginHostDB + Main.loginPortDB + Main.loginNameDB + Main.loginUserDB);
