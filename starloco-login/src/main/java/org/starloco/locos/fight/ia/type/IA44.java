...
public class IA44 extends AbstractNeedSpell  {
    ...
    public void apply() {
        if (!this.stop && this.fighter.canPlay() && this.count > 0) {
            ...
            Fighter A = Function.getNearestAminoinvocnbrcasemax(this.fight, this.fighter, 0, 5);//2 = po min 1 + 1;
            Fighter A1 = Function.getNearestAminoinvocnbrcasemax(this.fight, this.fighter, 0, 2);//2 = po min 1 + 1;
            ...
            if(this.fighter.getCurPm(this.fight) > 0 && A != null && A1 == null) {
                ...
                if(value != 0) {
                    ...
                    A1 = Function.getNearestAminoinvocnbrcasemax(this.fight, this.fighter, 0, 2);//2 = po min 1 + 1;
                }
            ...
            if(this.fighter.getCurPa(this.fight) > 0 && C != null && !action) {
                ...
                int value = Function.attackIfPossiblevisee(this.fight, this.fighter, A1, this.cacs);
                if(value != 0) {
                    time = value;
                    action = true;
                }
