...
public class IA38 extends AbstractNeedSpell  {
    ...
    public void apply() {
        if (!this.stop && this.fighter.canPlay() && this.count > 0) {
            ...
            Fighter A = Function.getNearestAminbrcasemax(this.fight, this.fighter, 0, maxPoBuff+1);//2 = po min 1 + 1;
            ...
            if(this.fighter.getCurPm(this.fight) > 0 && L == null && C == null && A == null && !this.boost) {
                int value = Function.moveautourIfPossible(this.fight, this.fighter, Function.getNearestAminbrcasemax(this.fight, this.fighter, 0, 100));
                if(value != 0) {
                    time = value;
                    action = true;
                    ...
                    A = Function.getNearestAminbrcasemax(this.fight, this.fighter, 0, maxPoBuff+1);//2 = po min 1 + 1;
                    if(maxPo == 1) L = null;
                }
