...
public class IA42 extends AbstractNeedSpell  {
    ...
    public void apply() {
        if (!this.stop && this.fighter.canPlay() && this.count > 0) {
            ...
            Fighter L = Function.getNearestinvocateurnbrcasemax(this.fight, this.fighter, 1, maxPo + 1);// pomax +1;
            ...
            if(this.fighter.getCurPa(this.fight) > 0 && !action && L != null && !this.boost) {
                if (Function.pmgongon(this.fight, this.fighter, L) != 0) {
                    time = 1000;
                    action = true;
                    this.boost = true;
                }
            ...
            if(this.fighter.getCurPa(this.fight) > 0 && !action && !this.heal) {
                if (Function.HealIfPossible(this.fight, this.fighter) != 0) {
                    time = 2000;
                    action = true;
                    this.heal = true;
                }
