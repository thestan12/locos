...
public class Main {
    ...
    public static int startLevel = 1, startKamas = 5000;
    ...
    public static String exchangeIp = "172.0.0.1";
    public static String loginHostDB = "172.28.1.10", loginNameDB = "login", loginUserDB = "root", loginPassDB = "password", loginPortDB = "3306";
    //Game
    public static int gamePort = 5555;
    public static String hostDB = "172.28.1.10", nameDB = "game", userDB = "root", passDB = "password", portDB = "3306";
    ...
    public static void main(String[] args) throws SQLException {
        ...
        Runtime.getRuntime().addShutdownHook(new Threa                      d() {
            public void run() {
                ...
                Main.logger.info("The server is now closed."  + test);
            }
        });
